 ...
 * @returns job id for async processing
 */
export async function updateUserCharacter(characterData) {
 ...
 */
export async function getPlazaCharacters(filters) {
 ...
 */
export async function getCharactersByCountry(country, limit = 100) {
 ...
 */
export async function getRandomCharacters(limit = 100) {
 ...
 */
export async function getOnlineCharacterPage(offset, limit = 8, filters) {
