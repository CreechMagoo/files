export { configureApi, setAuthToken, clearAuthToken, getAuthToken, isAuthenticated, initializeAuth, addAuthStateListener, generateSecureState, storeOAuthState, } from "./base/api-client.js";
// value arrays
export { SEX_VALUES, RACE_VALUES, ETHNICITY_VALUES, EYE_COLOR_VALUES, HAIR_COLOR_VALUES, } from "./base/types.js";
// auth
export { authenticateNewgrounds, getItchOAuthUrl, getGoogleOAuthUrl, verifySession, getCurrentUser, logout, isLoggedIn, handleOAuthPopup, loginWithItch, loginWithGoogle, } from "./auth.js";
// characters
export { getUserCharacter, uploadCharacter, updateUserCharacter, getPlazaCharacters, getCharacterById, hasCharacter, canEditCharacter, getCharactersByCountry, getRandomCharacters, getOnlineCharacterPage, validateCharacterData, } from "./characters.js";
// constants
export { CHARACTER_NAME_MAX_LENGTH, CHARACTER_NAME_REGEX, CHARACTER_NAME_ERROR_MESSAGE, COUNTRIES, MONTHS, SEXES, RACES, ETHNICITIES, EYE_COLORS, HAIR_COLORS, } from "./base/constants.js";
// utils
export { getJSONValue, setJSONValue, deleteJSONValue, isValidCountry, validateCharacterName, validateInputName, buildDateFromComponents, formatDateForDisplay, mapDropdownValueToKey, shouldDeleteField, handleRaceMutualExclusivity, sanitizeCharacterName, isPlayingOnNewgrounds, } from "./base/utils.js";
/**
 ...
 */
export function displayServerError(errorText, statusCode) {
...
// admin
export { listAllCharacters, getCharacterDetails, deleteCharacter, listAllUsers, getRecentCharacters, getDeletedCharacters, getAdminStats, validateAdminAccess, } from "./admin.js";
export const IdentikitAPI = {
    ...
    // admin methods
    admin: {
        characters: async (page, limit, showDeleted) => {
